...
unsigned int gettens(unsigned int);
unsigned int getfives(unsigned int);
unsigned int getones(unsigned int);

unsigned int gethalfs(unsigned int);
unsigned int getquarters(unsigned int);
